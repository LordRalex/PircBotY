...
public class SetSecretEvent<T extends PircBotY> extends Event<T> implements GenericChannelModeEvent<T> {
     ...
     */
    public SetSecretEvent(T bot, @NonNull Channel channel, @NonNull User user) {
        super(bot);
