...
public class SetPrivateEvent<T extends PircBotY> extends Event<T> implements GenericChannelModeEvent<T> {
     ...
     */
    public SetPrivateEvent(T bot, @NonNull Channel channel, @NonNull User user) {
        super(bot);
