...
public class RemoveModeratedEvent<T extends PircBotY> extends Event<T> implements GenericChannelModeEvent<T> {
     ...
     */
    public RemoveModeratedEvent(T bot, @NonNull Channel channel, @NonNull User user) {
        super(bot);
