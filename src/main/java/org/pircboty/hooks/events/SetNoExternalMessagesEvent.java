...
public class SetNoExternalMessagesEvent<T extends PircBotY> extends Event<T> implements GenericChannelModeEvent<T> {
     ...
     */
    public SetNoExternalMessagesEvent(T bot, @NonNull Channel channel, @NonNull User user) {
        super(bot);
