...
public class RemoveSecretEvent<T extends PircBotY> extends Event<T> implements GenericChannelModeEvent<T> {
     ...
     */
    public RemoveSecretEvent(T bot, @NonNull Channel channel, @NonNull User user) {
        super(bot);
