...
public class OutputChannel {
     ...
     *
     * @see #op(org.PircBotY.Channel, org.PircBotY.User)
     */
     ...
     * than with string concatenation. See {@link #setMode(org.PircBotY.Channel, java.lang.String)
     * }
     * for more information
     *
     * @param chan The channel on which to perform the mode change.
    ...
    /**
     * Set a mode for a user. See {@link #setMode(org.PircBotY.Channel, java.lang.String)
     * }
     *
     * @param chan The channel on which to perform the mode change.
     * @param mode The new mode to apply to the channel.
     * @param user The user to perform the mode change on
     * @see #setMode(org.PircBotY.Channel, java.lang.String)
     */
